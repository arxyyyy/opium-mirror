...
public class ModuleFakeDuelMessage extends Module {
    ...
    public void onEnable() {
        super.onEnable();
        mc.inGameHud.getChatHud().addMessage(Text.literal("[Duels] ").setStyle(Style.EMPTY.withFormatting(Formatting.BLUE))
                ...
                .append(Text.literal("0.0\u2665)").setStyle(Style.EMPTY.withFormatting(Formatting.LIGHT_PURPLE))));
