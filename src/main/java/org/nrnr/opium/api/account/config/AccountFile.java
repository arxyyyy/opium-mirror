package org.nrnr.opium.api.account.config;
...
import org.nrnr.opium.api.account.type.impl.CrackedAccount;
import org.nrnr.opium.api.account.type.impl.MicrosoftAccount;
...
public class AccountFile extends ConfigFile {
    ...
    public void save() {
        ...
        // error writing file
            ...
            Opium.error("Could not save file for accounts.json!");
            e.printStackTrace();
        }
    }
    ...
    public void load() {
        ...
        // error reading file
            ...
            Opium.error("Could not read file for accounts.json!");
            e.printStackTrace();
        }
    }
    ...
    protected void readFrom(final String content) {
        ...
        for (JsonElement element : json.asList()) {
            ...
            if (object.has("email") && object.has("password")) {
                ...
                if (!object.has("username")) {
                    Opium.error("Browser account does not have a username set?");
                    continue;
                }
            ...
            if (account != null) {
                ...
                Opium.error("Could not parse account JSON.\nRaw: {}", object.toString());
            }
        }
    }
}
