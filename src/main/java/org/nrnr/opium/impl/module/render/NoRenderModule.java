...
import org.nrnr.opium.impl.event.chunk.light.RenderSkylightEvent;
import org.nrnr.opium.impl.event.gui.hud.RenderOverlayEvent;
import org.nrnr.opium.impl.event.network.PacketEvent;
import org.nrnr.opium.impl.event.particle.ParticleEvent;
import org.nrnr.opium.impl.event.render.*;
import org.nrnr.opium.impl.event.render.block.RenderTileEntityEvent;
import org.nrnr.opium.impl.event.render.entity.RenderArmorEvent;
import org.nrnr.opium.impl.event.render.entity.RenderFireworkRocketEvent;
import org.nrnr.opium.impl.event.render.entity.RenderItemEvent;
import org.nrnr.opium.impl.event.render.entity.RenderWitherSkullEvent;
import org.nrnr.opium.impl.event.toast.RenderToastEvent;
import org.nrnr.opium.impl.event.world.BlindnessEvent;
...
public class NoRenderModule extends ToggleModule {
    ...
    Config<Boolean> armorConfig = new BooleanConfig("Armor", "Prevents armor pieces from rendering", true);
    ...
    Config<Boolean> totemConfig = new BooleanConfig("Totems", "Prevents totem particles from rendering", true);
