...
import org.nrnr.opium.impl.event.MouseUpdateEvent;
import org.nrnr.opium.impl.event.TickEvent;
import org.nrnr.opium.impl.event.camera.CameraPositionEvent;
import org.nrnr.opium.impl.event.PerspectiveEvent;
import org.nrnr.opium.impl.event.camera.CameraRotationEvent;
import org.nrnr.opium.impl.event.camera.EntityCameraPositionEvent;
import org.nrnr.opium.impl.event.entity.EntityRotationVectorEvent;
import org.nrnr.opium.impl.event.keyboard.KeyboardInputEvent;
import org.nrnr.opium.impl.event.network.DisconnectEvent;
import org.nrnr.opium.impl.event.render.BobViewEvent;
import org.nrnr.opium.impl.manager.player.rotation.Rotation;
import org.nrnr.opium.init.Managers;
import org.nrnr.opium.util.player.RayCastUtil;
...
public class FreecamModule extends ToggleModule {
    ...
    /**
     * Modified version of {@link org.nrnr.opium.impl.module.movement.SpeedModule#handleVanillaMotion(float)}
     */
