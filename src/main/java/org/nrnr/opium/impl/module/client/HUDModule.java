...
import org.nrnr.opium.util.StreamUtils;
...
public class HUDModule extends ToggleModule {
    ...
    Config<Boolean> watermark2Config = new BooleanConfig("Watermark 2", "Displays client name and version watermark, instead it shows: Opium", false);
