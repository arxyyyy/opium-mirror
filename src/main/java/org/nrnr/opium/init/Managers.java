package org.nrnr.opium.init;

import org.nrnr.opium.impl.manager.ModuleManager;
import org.nrnr.opium.impl.manager.anticheat.AntiCheatManager;
import org.nrnr.opium.impl.manager.client.*;
import org.nrnr.opium.impl.manager.combat.TotemManager;
import org.nrnr.opium.impl.manager.combat.hole.HoleManager;
import org.nrnr.opium.impl.manager.network.NetworkManager;
import org.nrnr.opium.impl.manager.player.InventoryManager;
import org.nrnr.opium.impl.manager.player.MovementManager;
import org.nrnr.opium.impl.manager.player.PositionManager;
import org.nrnr.opium.impl.manager.player.interaction.InteractionManager;
import org.nrnr.opium.impl.manager.player.rotation.RotationManager;
import org.nrnr.opium.impl.manager.world.ShaderManager;
import org.nrnr.opium.impl.manager.world.WaypointManager;
import org.nrnr.opium.impl.manager.world.sound.SoundManager;
import org.nrnr.opium.impl.manager.world.tick.TickManager;
