...
public class ClickGui
    ...
    public Setting<Float> fov = this.register(new Setting<>("Fov", 130f, -180f, 180f));
    public Setting<Integer> red = this.register(new Setting<>("Red", 142, 0, 255));
    ...
    public Setting<Integer> hoverAlpha = this.register(new Setting<>("Alpha", 120, 0, 255));
    public Setting<Integer> topRed = this.register(new Setting<>("SecondRed", 83, 0, 255));
