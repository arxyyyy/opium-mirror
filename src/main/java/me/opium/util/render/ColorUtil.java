...
public class ColorUtil {
    ...
    public static Color rainbow(int delay) {
        ...
        return Color.getHSBColor((float) ((rainbowState %= 360.0) / 360.0), UI.getInstance().rainbowSaturation.getValue().floatValue() / 255.0f, UI.getInstance().rainbowBrightness.getValue().floatValue() / 255.0f);
    }
