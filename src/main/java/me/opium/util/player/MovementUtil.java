...
public class MovementUtil extends Feature {
    ...
    public static boolean sprintIsLegit(float yaw) {
        return (Math.abs(Math.abs(MathHelper.wrapDegrees(yaw)) - Math.abs(MathHelper.wrapDegrees(Opium.rotationManager.getYaw()))) < 40);
    }
}
