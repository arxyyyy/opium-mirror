package me.opium.features.modules;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import me.opium.Opium;
import me.opium.event.impl.ClientEvent;
...
import me.opium.features.settings.Bind;
import me.opium.features.settings.Setting;
import me.opium.manager.ConfigManager;
import me.opium.util.traits.Jsonable;
...
public class Module extends Feature implements Jsonable {
    ...
    public void enable() {
        ...
        switch (Debug.INSTANCE.notification.getValue()) {
            ...
            case Opium -> Command.sendMessage(Formatting.DARK_GREEN + "[+] " + Formatting.WHITE + getName());
    ...
    public void disable() {
        ...
        switch (Debug.INSTANCE.notification.getValue()) {
            ...
            case Opium -> Command.sendMessage(Formatting.DARK_RED +"[+] "+ Formatting.WHITE+getName());
