...
import me.opium.event.eventbus.EventHandler;
import me.opium.event.eventbus.EventPriority;
import me.opium.event.impl.LookAtEvent;
import me.opium.event.impl.MoveEvent;
import me.opium.features.modules.Module;
import me.opium.features.settings.Setting;
import me.opium.util.models.Timer;
import me.opium.util.module.MovementUtil;
import me.opium.util.player.InventoryUtil2;

import me.opium.util.world.BlockUtil2;
import net.minecraft.util.math.BlockPos;
import net.minecraft.util.math.Direction;
import net.minecraft.util.math.Vec3d;

import static me.opium.util.world.BlockUtil2.getPlaceSide;
