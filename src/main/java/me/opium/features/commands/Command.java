package me.opium.features.commands;
...
public abstract class Command
    ...
    public static void sendMessage(String message) {
        Command.sendSilentMessage(Opium.commandManager.getClientMessage() + " " + Formatting.GRAY + message);
    }
    ...
    public static String getCommandPrefix() {
        return Opium.commandManager.getPrefix();
    }
