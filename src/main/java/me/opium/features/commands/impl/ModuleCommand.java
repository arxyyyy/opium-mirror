...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Opium.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Opium.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Opium.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Opium.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
