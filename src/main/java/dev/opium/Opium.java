...
import dev.opium.api.events.eventbus.EventBus;
import dev.opium.core.impl.*;
...
public final class Opium implements ModInitializer {
    ...
    public static void load() {
        ...
        PREFIX = Opium.CONFIG.getString("prefix", ";");
        ...
        CONFIG.loadSettings();
        System.out.println("[" + Opium.NAME + "] loaded");
    ...
    public static void unload() {
        loaded = false;
        System.out.println("[" + Opium.NAME + "] Unloading..");
        EVENT_BUS.listenerMap.clear();
        ConfigManager.resetModule();
        System.out.println("[" + Opium.NAME + "] Unloaded");
    }

    public static void save() {
        System.out.println("[" + Opium.NAME + "] Saving");
        CONFIG.saveSettings();
        FRIEND.save();
        XRAY.save();
        TRADE.save();
        System.out.println("[" + Opium.NAME + "] Saved");
    }
}
