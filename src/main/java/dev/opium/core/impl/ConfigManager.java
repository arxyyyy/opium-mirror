...
import dev.opium.mod.modules.impl.client.ModuleList;
import dev.opium.mod.modules.settings.Setting;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : Opium.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : Opium.MODULE.modules) {
			...
			module.setState(Opium.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + Opium.PREFIX);

			for (ClickGuiTab tab : Opium.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + Opium.GUI.armorHud.getX());
			printwriter.println("armor_y:" + Opium.GUI.armorHud.getY());
			...
			System.out.println("[" + Opium.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + Opium.NAME + "] Failed to load settings");
		}
	}
