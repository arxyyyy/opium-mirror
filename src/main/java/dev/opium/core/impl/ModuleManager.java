...
import dev.opium.mod.Mod;
import dev.opium.mod.gui.clickgui.ClickGuiScreen;
import dev.opium.mod.modules.Module;
import dev.opium.mod.modules.impl.client.*;
import dev.opium.mod.modules.impl.combat.*;
import dev.opium.mod.modules.impl.exploit.*;
import dev.opium.mod.modules.impl.misc.*;
import dev.opium.mod.modules.impl.movement.*;
import dev.opium.mod.modules.impl.player.*;
import dev.opium.mod.modules.impl.player.freelook.FreeLook;
import dev.opium.mod.modules.impl.render.*;
import dev.opium.mod.modules.settings.Setting;
import dev.opium.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        Opium.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
