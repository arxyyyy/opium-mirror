...
import dev.opium.api.events.impl.ClickBlockEvent;
...
import dev.opium.asm.accessors.IPlayerMoveC2SPacket;
...
import dev.opium.mod.modules.impl.combat.AutoAnchor;
import dev.opium.mod.modules.impl.combat.AutoCev;
import dev.opium.mod.modules.impl.combat.AutoCrystal;
import dev.opium.mod.modules.settings.SwingSide;
import dev.opium.mod.modules.settings.impl.*;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = Opium.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
