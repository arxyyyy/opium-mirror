...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(Opium.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Opium.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Opium.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
