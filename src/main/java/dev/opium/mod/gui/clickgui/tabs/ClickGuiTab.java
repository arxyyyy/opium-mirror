...
public class ClickGuiTab extends Tab {
	...
	public ClickGuiTab(String title, int x, int y) {
		this.title = title;
		this.x = Opium.CONFIG.getInt(title + "_x", x);
		this.y = Opium.CONFIG.getInt(title + "_y", y);
		this.width = 98;
